...
# ACDS 17.1 590 win32 2018.09.09.18:13:08
# ----------------------------------------
...
# ----------------------------------------
# If pll_adc_datain is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_adc_datain"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_adc_datain.vo"
}
